...
const greeting = {
  ...
  resumeLink: require("./assets/AYUSHI_NEMA_SE_2yrs_CV.pdf"), // Set to empty to hide the button
...
const bigProjects = {
  ...
  projects: [
    ...
    },
    {
      ...
      projectName:
        "Transmission Corporation of Telangana Ltd State Load Despatch Centre Renewable Energy Management Centre",
      //projectDesc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit",
      footerLink: [
        {
          name: "Visit Website",
...
const achievementSection = {
  ...
  achievementsCards: [
...

    {
      ...
      subtitle:
        "The workshop of 4 wheeled bots using Arduino organised by Platforuma.",
      image: require("./assets/images/platforuma.jpg"),
      imageAlt: "platforuma_logo",
      footerLink: [
